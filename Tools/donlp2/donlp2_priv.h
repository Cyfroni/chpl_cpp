#ifndef DONLP2_PRIV_H
#define DONLP2_PRIV_H
...
static INTEGER  qpterm,fcount,qpitma;

static INTEGER  ndual,mi,me,iq;
static DOUBLE   *np,rnorm,rlow,**xj,
                *ddual, **r,*ud,
                *ud1;

static INTEGER  iptr,iqtr,*aitr;
static DOUBLE   sstr,riitr;

#pragma omp threadprivate (qpterm,fcount,qpitma,ndual,mi,me,iq,np,rnorm,rlow,xj,ddual,r,ud,ud1,iptr,iqtr,aitr,sstr,riitr)
